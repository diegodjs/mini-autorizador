...
public class AutorizadorTest {
	...
	@Test
	public void criarCartaoErroAutenticacaoTest() throws Exception {
	...
	public void obterSaldoCartaoInexistenteTest() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(get("/cartoes/"+"1111111111111111")
						.contentType(MediaType.APPLICATION_JSON)
						.header("Authorization", "Basic dXNlcm5hbWU6cGFzc3dvcmQ="))
	...
	@Test
	public void obterSaldoCartaoErroAutenticacaoTest() throws Exception {
	...
	@Test
	public void realizarTransacaoErroAutenticacaoTestTest() throws Exception {
